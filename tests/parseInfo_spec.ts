...
describe('parseInfo', () => {
  ...
  describe('newList', () => {
    ...
    it('should capture source information', () => {
      let pi = parseInfo([{meta:{_sourceFile:'!.hl'}}], '\n\nword:');
      pi.popWord()
      pi.popWord()
      pi.popWord().should.eql('word');
      pi.newList()
